...
const id: FC<Props> = ({ product }) => {
  ...
  return (
    <>
      <Head>
        <title>MWAN</title>
        <meta name="title" content={`MWAN | ${product.name}`} />
        <meta name="description" content={product?.overview} />

        <meta property="og:type" content="website" />
        <meta property="og:url" content={`https://dtic.co/products/${id}`} />
        <meta property="og:title" content={`MWAN | ${product.name}`} />
        ...
        <meta property="twitter:url" content={`https://dtic.co/products/${id}`} />
        <meta property="twitter:title" content={`MWAN | ${product.name}`} />
